...
\begin{itemize}
    \item As Code Approver for backend and db migrations, I have implemented and coordinated release of a new permissions model and AI-backed recruitment sourcing.
    \item Architected a Kafka pipeline and stream processor in Scala with FP principles, Hyperloop, which aggregates on Postgres change data events and sinks to Elasticsearch bringing down sync frequency from 24h to $<1$s.
...
\section*{SKILLS}
{\large \bf Proficient}
Typescript, Javscript, Scala, Go, C, C\#, C++, Java, Swagger/OpenAPI, Kafka, Python, HTML, CSS, React, Docker,
